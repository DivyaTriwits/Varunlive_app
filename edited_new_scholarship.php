                ...
                <div class="col-lg-12">
                    <div class="text-center">
                        <h1 class="text-capitalize section-heading" style="margin-bottom: 30px">
                            ...
                            elseif ($scholarshipsCategory == "") {
                               $scholarshipsCategory = "filter by Course "; 
                                echo $scholarshipsCategory;
                            }
                            else{
                                echo $scholarshipsCategory;
...
<script>
    function goBack() {
        // Use JavaScript to navigate back in the browser history
        window.history.back();
    }
</script>
<?php if ($previous_page=='Scholarship'){?>
    <a href="<?php echo base_url('scholarships/'.'Scholarship')?>" class="btn btn-primary ml-2" style="display: block; margin: 5px auto;margin-left: 40px!important;text-align: left;">Clear Filter</a>
    
<?php }elseif ($previous_page=='Abroad') {?>
     <a href="<?php echo base_url('scholarships/'.'Abroad')?>" class="btn btn-primary ml-2" style="display: block; margin: 5px auto;margin-left: 40px!important;text-align: left;">Clear Filter</a>
    <?php }else{?>
         <a href="<?php echo base_url('scholarships/'.'Competitions and Awards')?>" class="btn btn-primary ml-2" style="display: block; margin: 5px auto;margin-left: 40px!important;text-align: left;">Clear Filter</a>
    <?php }?>
