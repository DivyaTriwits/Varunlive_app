...
<body>
 ...
 <!--  <div class="scroll-button">
  ...
  <nav>
    <div class="navbar">
      <div class="logo"><a href="<?php echo base_url();?>main"><img src="<?=base_url('assets/image/logo 1.png'); ?>" alt="MyWeb Logo"></a></div>
      <ul class="menu">
        <li><a href="#about">WHY US</a></li>
        <li><a href="#services">SOLUTIONS</a>
          <ul class="sub-menu">
            <li><a href="<?php echo base_url();?>lead-management">Lead Management</a></li>
            <li><a href="<?php echo base_url();?>data-solution">Data Solutions</a></li>
            <li><a href="#graphic-design">Sales Targetting</a></li>
            <li><a href="#graphic-design">Digital Marketing</a></li>
            <li><a href="#graphic-design">Programatic Ads</a></li>
            <li><a href="#graphic-design">Customer Events</a></li>
            <!-- Add other service items here -->
          </ul></li>
        <li><a href="#services">LEAD FORWARD</a></li>
