...
<body>
  ...
  <section class="section-1">
    ...
    <!-- Transparent gray overlay below the diagonal division -->
    <div class="gray-overlay"><h1>Data Solutions</h1><p>At SeamNux, we take pride in offering a comprehensive range of <br> solutions that empower businesses with highly effective and <br> results-oriented marketing strategies. Our diverse suite of <br> services is carefully crafted to cater to the unique needs <br> and goals of each client, ensuring maximum impact and success. <br> we are committed to driving exceptional growth for your <br> business.</p>
    </div>
