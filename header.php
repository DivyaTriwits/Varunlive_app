...
<body class="horizontalmenu">	
	...
	<div id="global-loader">
		<img style="max-width: 200px;" src="<?php echo base_url()?>assets/img/brand/tgs-logo.png" class="loader-img" alt="Loader">
	</div>
	<!-- End Loader -->
<style type="text/css">
		#backbutton
	...
	<div class="page">
		...
		?>
		<!-- Main Header-->
		<div class="main-header horizontal-header " style="position: fixed; padding: 40px;">
			<div class="container">
				...
				<a href="<?php if($backbutton!='') echo base_url('/'.$backbutton)?>">
					...
					<div class="main-header-left">
						...
						<!--<a class="main-logo text-center" href="<?php echo base_url('support_dashboard')?>">-->
						<!--	<img style="max-width: 130px;" src="<?php echo base_url()?>assets/img/brand/tgs-logo.png" class="header-brand-img desktop-logo" alt="logo">-->
						<!--	<img style="max-width: 130px;" src="<?php echo base_url()?>assets/img/brand/tgs-logo.png" class="header-brand-img desktop-logo theme-logo" alt="logo">-->
						<!--</a>-->
					</div>
					<div class="main-header-center">
						<div class="responsive-logo">
							<a  style="max-width: 130px;" href="<?php echo base_url('support_dashboard')?>"><img height="55px !important" src="<?php echo base_url()?>assets/img/brand/tgs-logo.png" class="mobile-logo" alt="logo"></a>
							<a style="max-width: 130px;" href="<?php echo base_url('support_dashboard')?>"><img src="<?php echo base_url()?>assets/img/brand/tgs-logo.png" class="mobile-logo-dark" alt="logo"></a>
						</div>
					...
					<!-- for displaying super admin name on 4 aug by varun -->
								<?php }elseif($this->session->userdata('role')!='' && $this->session->userdata('role')=="super-admin"){?>
									<h6 class="main-notification-title"><?php echo $this->session->userdata('name') ?></h6>
								<?php } else {?>
									<h6 class="main-notification-title"><?php if($this->session->userdata('name')!=''){  echo $this->session->userdata('name'); } ?></h6>
								<?php }?>

								<!-- <h6 class="main-notification-title"><?php echo $this->session->userdata('registered_email')?></h6> -->
								<!-- <p class="main-notification-text">Web Designer</p> -->
							</div>
							<?php if($this->session->userdata('role')!='' && $this->session->userdata('role')=="Admin"){?>

								<a class="dropdown-item border-top" href="<?php echo base_url()?>support-admin-profile">
									<i class="fe fe-user"></i> My Profile
								</a>
					<!-- for displaying super admin profile on 4 aug by varun -->
							<?php }elseif($this->session->userdata('role')!='' && $this->session->userdata('role')=="super-admin"){?>
								<a class="dropdown-item border-top" href="<?php echo base_url()?>support-superadmin-profile">
									<i class="fe fe-user"></i> My Profile
								</a>
							<?php } else {?>

								<a class="dropdown-item border-top" href="<?php echo base_url()?>support-profile-page">
									<i class="fe fe-user"></i> My Profile
								</a>
							...
							<?php if($this->session->userdata('role')!='' && $this->session->userdata('role')=="Admin"){?>
								...
								<a class="dropdown-item" href="<?php echo base_url()?>support-admin-logout">
									<i class="fe fe-power"></i> Sign Out
								</a>
					<!-- for displaying super admin logout on 4 aug by varun -->
							<?php }elseif($this->session->userdata('role')!='' && $this->session->userdata('role')=="super-admin"){?>
								<a class="dropdown-item border-top" href="<?php echo base_url()?>support-superadmin-logout">
									<i class="fe fe-user"></i> My Profile
								</a>

							<?php } else { ?>

								<a class="dropdown-item" href="<?php echo base_url()?>support-logout">
									<i class="fe fe-power"></i> Sign Out
								</a>
