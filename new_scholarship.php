    ...
    <section id="courses-section" class="popular-courses-area " >
        <div class="container" style="padding-top:38px !important">
            <div class="row justify-content-md-center">
                ...
                <!-- Add the search input field and button -->
 <!--  <div class="col-lg-4 col-md-6">
        <div class="form-group">
          <form action="<?php echo base_url('filter-by-course');?>" method="POST" enctype="multipart/form-data">
            <label for="courseFilter">Filter by Course:</label>
            <select class="form-control add-scholarship-select2" id="qualification" name="qualification">
...
<!-- <div class="col-lg-4 col-md-6">
        <div class="form-group">
            <form action="<?php echo base_url('filter-by-course')?>" method="GET"  class="d-flex">
                <label for="courseFilter">Filter by Course:</label>
                <select class="form-control add-scholarship-select2" id="qualification" name="qualification" style="cursor: pointer;border-radius: 10px;background-color:white; border: 2px solid  #4b0082;">
                    <option label="Choose one"></option>
                    <?php if($getCourse->num_rows() > 0): ?>
                        <?php foreach($getCourse->result() as $row): ?>
                            <option value="<?php echo $row->course_name; ?>">
                                <?php echo $row->course_name; ?>
                            </option>
                        <?php endforeach; ?>
                ...
                <input type="hidden" name="type" id="type" value="<?php echo $scholarshipsCategory; ?>">
                <button type="submit" id="searchBtn" class="btn btn-primary mt-2">Search</button>
            </form>
        </div>
    </div> -->
   <div class="container">
    <form action="<?php echo base_url('filter-by-course')?>" method="GET" class="d-flex align-items-center">
        <label for="courseFilter">Course Filter:</label>
        <select class="form-control add-scholarship-select2 ml-2" id="qualification" name="qualification" style="cursor: pointer;border-radius: 10px;background-color:white; border: 2px solid  #4b0082;width: 200px;">
            <option label="Choose one"></option>
            <?php if($getCourse->num_rows() > 0): ?>
                <?php foreach($getCourse->result() as $row): ?>
                    <option value="<?php echo $row->course_name; ?>">
        ...
        <input type="hidden" name="type" id="type" value="<?php echo $scholarshipsCategory; ?>">
        <button type="submit" id="searchBtn" class="btn btn-primary ml-2">Search</button>
    </form>
</div>
<br><br>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#searchBtn').click(function() {
                const selectedCourse = $('#qualification').val(); // Get the selected course value

                // Make an AJAX request to the controller with the selected course as a URL parameter
                $.ajax({
                    url: '<?php echo base_url('filterbycourse')?>?qualification=' + selectedCourse,
                    type: 'GET',
                    dataType: 'json',
